...
import { View, Text, TextInput, TouchableOpacity, ActivityIndicator, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard, StyleSheet, Image } from 'react-native';
...
export default function LoginScreen() {
  ...
  useEffect(() => {
    // We configure GoogleSignin once the component mounts
    // For iOS and Web client IDs, these should ideally come from Expo Env Variables
          ...
          <View style={styles.content}>
            ...
            <View style={styles.header}>
              <View style={styles.iconContainer}>
                <MaterialCommunityIcons name="finance" size={52} color="#10B981" />
              </View>
              <Text style={styles.title}>AzSignal Pro</Text>
            ...
            <View style={styles.footer}>
              <Text style={styles.footerText}>New to AzSignal? </Text>
              <TouchableOpacity onPress={() => router.push('/(auth)/register')} style={styles.footerLinkContainer}>
